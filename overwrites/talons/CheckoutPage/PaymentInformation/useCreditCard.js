...
export const useCreditCard = props => {
    ...
    const shippingAddressCountry = shippingAddressData && shippingAddressData.cart.shippingAddresses.length && shippingAddressData.cart.shippingAddresses.length > 0
